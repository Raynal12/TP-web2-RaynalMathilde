...
public class CityController {
	...
	private static final String DEFAULT_VIEW = "hello";
        ...
        private static final String MODIF_CITY_VIEW = "formulaireCity";
	/**
...
//	}
	...
	public String enregistreUneVille(City laVille) {
        ...
        @GetMapping(path="delete") // Requête HTTP POST à l'URL http://localhost:8989/cities/save
	public String supprimerUneVille(@RequestParam("id") City laVille) {
        ...
        @GetMapping(path = "formulaireCity") //à l'URL http://localhost:8989/cities/show
	public String formulaireCity(Model model) {
		log.info("On affiche le formulaire");
		return MODIF_CITY_VIEW;
        }
        
        @GetMapping(path = "edit")
	public String montreLeFormulairePourEdition(@RequestParam("id") int id ,City laVille, Model model) {
        ...
        /*
        @PostMapping(path="remove") // Requête HTTP POST à l'URL http://localhost:8989/cities/save
	public String modifierUneVille(@RequestParam("id") City laVille) {
		cityDao.remove(laVille);
		log.info("La ville {} a été enregistrée", laVille);
		// On redirige vers la page de liste des villes
		return "redirect:/cities/show";
	}
*/
	...
	public String remove(@RequestParam("id") City laVille, Model model) {
		model.addAttribute("laVille", laVille);
		return "redirect:/cities/formulaireCity";
	}
        */
